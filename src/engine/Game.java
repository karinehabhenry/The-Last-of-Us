...
//		Fighter h1=new Fighter("Ellie",60,20,100);
//		availableHeroes.add(h1);
//		Fighter h2=new Fighter("Joel",60,20,100);
//		availableHeroes.add(h2);
//		Fighter h3=new Fighter("Riley",60,20,100);
//		availableHeroes.add(h3);
//		Medic h4=new Medic("Tommy",60,20,100);
//		availableHeroes.add(h4);
//		Medic h5=new Medic("Henry",60,20,100);
//		availableHeroes.add(h5);
//		Medic h6=new Medic("Tess",60,20,100);
//		availableHeroes.add(h6);
//		Explorer h7=new Explorer("Bill",60,20,100);
//		availableHeroes.add(h7);
//		Explorer h8=new Explorer("Abby",60,20,100);
//		availableHeroes.add(h8);
//		
	...
	public static void main (String[] args) {
		Hero h=new Hero("h",40,20,2);
		availableHeroes.add(h);
	System.out.print(availableHeroes.get(0));
